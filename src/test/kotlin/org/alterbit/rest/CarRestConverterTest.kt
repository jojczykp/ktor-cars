...
class CarRestConverterTest : ShouldSpec({

    val converter = CarRestConverter()
    ...
    context("create request") {
        ...
        should("create command from request") {
            ...
            val command = converter.requestToCommand(request)
        ...
        should("create command from request propagating all fields") {
            ...
            val command = converter.requestToCommand(id, request)
    ...
    context("response") {
        ...
        should("create response from car") {
            ...
            val response = converter.modelToResponse(car)
